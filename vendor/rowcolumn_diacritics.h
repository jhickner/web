// Generated from kitty gen/rowcolumn-diacritics.txt (Unicode 6.0.0 Mn/230
// combining marks). Index N encodes row/column N.

#ifndef ROWCOLUMN_DIACRITICS_H
#define ROWCOLUMN_DIACRITICS_H
...
#define ROWCOLUMN_DIACRITICS_COUNT \
    ((int)(sizeof rowcolumn_diacritics / sizeof rowcolumn_diacritics[0]))
